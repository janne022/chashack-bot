...
export const TAG_DEFS: { tag: string; label: string; desc: string; example: string; context: string }[] = [
  ...
  { tag: "{start_date}", label: "Start date (alias)", desc: "Same as {startsAt} — absolute start.", example: "<t:171578:F>", context: "needs startsAt" },
  { tag: "{endsAt}", label: "End date (full)", desc: "Absolute end date.", example: "<t:17158:F>", context: "needs endsAt" },
  { tag: "{end_date}", label: "End date (alias)", desc: "Same as {endsAt} — absolute end.", example: "<t:17158:F>", context: "needs endsAt" },
